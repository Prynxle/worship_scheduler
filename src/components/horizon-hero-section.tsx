  ...
  useEffect(() => {
    ...
    const createNebula = () => {
      ...
      const material = new THREE.ShaderMaterial({
        uniforms: {
          time: { value: 0 },
          color1: { value: new THREE.Color(0x001a66) },
          color2: { value: new THREE.Color(0x660033) },
          opacity: { value: 0.3 }
        },
        vertexShader: `
          varying vec2 vUv;
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const cameraPositions = [
        { x: 0, y: 30, z: 150 },    // Section 0 - HORIZON
...
<h1 ref={titleRef} className="hero-title">
        ...
        <div ref={subtitleRef} className="hero-subtitle cosmos-subtitle">
          ...
          <p className="subtitle-line">
           we discover the life God has called us to live.
          </p>
        </div>
      </div>
      ...
      <div className="scroll-sections">
       {[...Array(2)].map((_, i) => {
          ...
          const subtitles = {
            0: {
              line1: 'Beyond the boundaries of what we can see,',
              line2: "lies a future held in God's promises.",
            },
            1: {
